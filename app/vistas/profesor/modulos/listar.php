        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <div class="fs-6 fw-semibold text-muted">Activos</div>
                        <div class="fs-4 fw-bold text-dark"><?= count(array_filter($datos['modulos'], function($m) { return $m['total_examenes'] > 0; })) ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <div class="fs-6 fw-semibold text-muted">Sin Exámenes</div>
                        <div class="fs-4 fw-bold text-dark"><?= count(array_filter($datos['modulos'], function($m) { return $m['total_examenes'] == 0; })) ?></div>
                    </div>
                </div>
            </div>
