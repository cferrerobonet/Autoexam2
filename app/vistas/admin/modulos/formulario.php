                ...
                <form method="POST" action="<?= BASE_URL ?>/modulos/crear" novalidate>
                    ...
                    <div class="mb-4">
                        <label for="id_profesor" class="form-label">
                            <i class="fas fa-chalkboard-teacher me-1"></i>Profesor asignado <span class="text-danger">*</span>
                        </label>
                        <select class="form-select form-select-lg" id="id_profesor" name="id_profesor" required>
                        ...
                        <div class="form-text">
                            <i class="fas fa-info-circle me-1"></i>
                            Profesor responsable de impartir este módulo
                        </div>
                    </div>
                    
                    <div class="mb-4">
                        <label class="form-label">
                            <i class="fas fa-book-open me-1"></i>Cursos asignados <span class="text-danger">*</span>
                        </label>
                        <div class="border rounded p-3 bg-light">
                            <div class="form-text mb-3">
                                <i class="fas fa-info-circle me-1"></i>
                                Seleccione los cursos donde se impartirá este módulo
                            </div>
                            ...
                            <?php else: ?>
                                <div class="alert alert-warning mb-0">
                                    ...
                                    No hay cursos disponibles. <a href="<?= BASE_URL ?>/cursos/nuevo" class="alert-link">Crear un curso</a> antes de continuar.
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="card shadow-sm mb-3">
            ...
            <div class="card-body">
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-2">
                        <i class="fas fa-check-circle text-success me-2"></i>
                        <small>El profesor asignado puede gestionar el módulo</small>
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-check-circle text-success me-2"></i>
                        <small>Los exámenes se crean dentro de cada módulo</small>
                    </li>
                    <li class="mb-0">
                        <i class="fas fa-check-circle text-success me-2"></i>
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="border-end">
                            <div class="fs-4 fw-bold text-primary"><?= count($datos['profesores']) ?></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const profesor = document.getElementById('id_profesor');
    const submitBtn = form.querySelector('button[type="submit"]');
    
    function validarFormulario() {
        const tituloValido = titulo.value.trim().length > 0;
        const profesorValido = profesor.value !== '';
        
        if (tituloValido && profesorValido) {
        ...
        } else if (profesor.hasAttribute('data-touched')) {
            profesor.classList.remove('is-valid');
            profesor.classList.add('is-invalid');
        }
    }
    
    titulo.addEventListener('input', validarFormulario);
    profesor.addEventListener('change', function() {
