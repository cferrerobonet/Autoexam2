<?php
/**
 * Vista de Importación de Cursos - AUTOEXAM2
 */
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-upload me-2"></i> Importar Cursos</h2>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <ol>
                        ...
                        <li>Las columnas requeridas son: <strong>Nombre, Descripción, Correo Profesor</strong></li>
                        <li>El correo del profesor debe existir en el sistema y tener rol "profesor"</li>
                        <li>Los cursos se crearán como activos por defecto</li>
                    </ol>
                    
                    <div class="mt-3">
                        <a href="<?= BASE_URL ?>/cursos/plantilla-csv" class="btn btn-outline-primary btn-sm">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= BASE_URL ?>/cursos/procesar-importacion" method="POST" enctype="multipart/form-data" id="formImportar">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="confirmarImportacion">
                                Confirmo que el archivo CSV tiene el formato correcto y entiendo que esta acción creará nuevos cursos en el sistema.
                            </label>
                        </div>

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?= BASE_URL ?>/cursos" class="btn btn-outline-secondary me-md-2">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <pre class="bg-light p-3 rounded"><code>Nombre;Descripción;Correo Profesor
Matemáticas Básicas;Curso introductorio de matemáticas;profesor.matematicas@ejemplo.com
Historia Universal;Recorrido por la historia mundial;profesor.historia@ejemplo.com
Ciencias Naturales;Introducción a las ciencias;profesor.ciencias@ejemplo.com</code></pre>
                </div>
            </div>
        </div>
    </div>
