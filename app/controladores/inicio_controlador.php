...
class InicioControlador {
    ...
    private function dashboardProfesor() {
        ...
        // Cargar scripts al final para mejor rendimiento y funcionamiento
        ?>
        ...
        <!-- Scripts específicos del profesor -->
        <script src="<?= BASE_URL ?>/recursos/js/profesor_dashboard.js"></script>
        </body>
        </html>
        <?php
    }
